...
char cube[6][10] {}; //above, below, front, rear, left, right
...
void turn(char alpha, char d) {
    if(alpha=='U') {
        char temp[3] = {cube[2][1], cube[2][2], cube[2][3]};
        if(d=='+') {
            rotate(0);
            cube[2][1] = cube[5][1];
            cube[2][2] = cube[5][2];
        ...
        char temp[3] = {cube[2][7], cube[2][8], cube[2][9]};
        if(d=='+') {
            rotate(1);
            cube[2][7] = cube[4][7];
            cube[2][8] = cube[4][8];
        ...
        int temp[3] = {cube[0][7], cube[0][8], cube[0][9]};
        if(d=='+') {
            rotate(2);
            cube[0][7] = cube[4][9];
            cube[0][8] = cube[4][6];
        ...
        int temp[3] = {cube[0][1], cube[0][2], cube[0][3]};
        if(d=='+') {
            rotate(3);
            cube[0][1] = cube[5][3];
            cube[0][2] = cube[5][6];
        ...
        char temp[3] = {cube[0][1], cube[0][4], cube[0][7]};
        if(d=='+') {
            rotate(4);
            cube[0][1] = cube[3][1];
            cube[0][4] = cube[3][4];
        ...
        char temp[3] = {cube[0][3], cube[0][6], cube[0][9]};
        if(d=='+') {
            rotate(5);
            cube[0][3] = cube[2][3];
            cube[0][6] = cube[2][6];
...
void print() {
    rep(i,1,9) cout << cube[0][i] << " ";
    cout << endl;
    rep(i,1,9) cout << cube[1][i] << " ";
    cout << endl;
    rep(i,1,9) cout << cube[2][i] << " ";
    cout << endl;
    rep(i,1,9) cout << cube[3][i] << " ";
    cout << endl;
    rep(i,1,9) cout << cube[4][i] << " ";
    cout << endl;
    rep(i,1,9) cout << cube[5][i] << " ";
    cout << endl << endl;
}
void Solve() {
    rep(i,1,9) cube[0][i] = 'w';
    rep(i,1,9) cube[1][i] = 'y';
    rep(i,1,9) cube[2][i] = 'r';
    rep(i,1,9) cube[3][i] = 'o';
    rep(i,1,9) cube[4][i] = 'g';
    rep(i,1,9) cube[5][i] = 'b';

    cin >> N;
    while(N--) {
        char alpha, d; cin >> alpha >> d;
        turn(alpha, d);
    }
    rep(i,1,9) {
        cout << cube[0][i];
