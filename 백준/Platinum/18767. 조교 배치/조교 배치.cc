...
#define MAX 101 //MAX should be treated carefully since space complexity is limited. (256mb, 512mb)
vector<int> edge[MAX];
...
void Solve() {
	...
	addEdge(2, bias+2, INF);
	addEdge(3, bias+1, INF);
	addEdge(3, bias+2, INF);
	addEdge(4, bias+3, INF);
	addEdge(5, bias+3, INF);
	addEdge(5, bias+1, INF);
	addEdge(6, bias+2, INF);
	addEdge(6, bias+3, INF);
	addEdge(7, bias+1, INF);
