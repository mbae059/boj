...
void Solve() {
    ...
    while(N--) {
        ...
        else if(str=="MR") turnRight(dir);
        else if(str=="ML") turnLeft(dir);

        cout << p.first << " " << p.second << " " << p.first + dx[dir] << " " << p.second + dy[dir] << endl;
    }
}
int32_t main() {
