...
void Solve() {
    ...
    auto process = [&]() {
        if(cur.empty()) return;
        if(cur=="C+" || cur=="C" || cur=="C0" || cur=="C-") answer.pbk('B');
        else if(cur=="B0" || cur=="B-" || cur=="B") {
            if(pre.empty() || pre=="C+" || pre=="C" || pre=="C0" || pre=="C-") answer.pbk('D');
            else answer.pbk('B');
        }
        else if(cur=="A-" || cur=="B+") {
            if(pre.empty() || pre=="B0" || pre=="B-" || pre=="B" || pre=="C+" || pre=="C0" || pre=="C" || pre=="C-") answer.pbk('P');
            else answer.pbk('D');
        }
        else if(cur=="A0" || cur=="A") {
            if(!pre.empty() && (pre=="A+" || pre=="A0" || pre=="A")) answer.pbk('P');
            else answer.pbk('E');
        }
        else if(cur=="A+") answer.pbk('E');
