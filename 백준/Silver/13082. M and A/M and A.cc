...
void Solve() {
    ...
    auto go = [](const string& str1, const string& str2, const string& target) -> bool {
        int idx1 = -1;
        int idx2 = -1;
        string str;
        int idx = 0;
        while(str!=target && idx1<int(str1.size()) && idx2<int(str2.size())) {
            bool flag1 =0;
            bool flag2 = 0;
            for(int i=idx1+1;i<str1.size();i++) {
                if(str1[i]==target[idx]) {
                    str.pbk(target[idx]);
                    idx1 = i;
                    idx++;
                    flag1=1;
            ...
            for(int i=idx2+1;i<str2.size();i++) {
                if(str2[i]==target[idx]) {
                    str.pbk(target[idx]);
                    idx2 = i;
                    idx++;
                    flag2=1;
    ...
    if(go(str1,str2,str1) || go(str2,str1,str1)) print("Yes");
    else print("No");
}
int32_t main() {
