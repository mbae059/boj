...
void Solve() {
    ...
    rep(i,1,N) {
        dpMin[1][0] = min(dpMin[0][0], dpMin[0][1]) + matrix[i][0];
        dpMin[1][1] = min({dpMin[0][0], dpMin[0][1], dpMin[0][2]}) + matrix[i][1];
        dpMin[1][2] = min(dpMin[0][1], dpMin[0][2]) + matrix[i][2];

        dpMax[1][0] = max(dpMax[0][0], dpMax[0][1]) + matrix[i][0];
        dpMax[1][1] = max({dpMax[0][0], dpMax[0][1], dpMax[0][2]}) + matrix[i][1];
        dpMax[1][2] = max(dpMax[0][1], dpMax[0][2]) + matrix[i][2];
    ...
    cout << max({dpMax[0][0], dpMax[0][1], dpMax[0][2]}) << " " << min({dpMin[0][0], dpMin[0][1], dpMin[0][2]});
}
int main() {
