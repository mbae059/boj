...
void Solve() {
    ...
    rep(i,1,N) {
        ...
        if(cur==val) val++;
            ...
            if(dq[1].empty() && dq[2].empty()) dq[1].pbk(cur);
            else if(!dq[1].empty() && dq[2].empty()) {
                if(dq[1].back()+1 == cur) dq[1].pbk(cur);
                else dq[2].pbk(cur);
            }
            else if(dq[1].empty() && !dq[2].empty()) {
                if(dq[2].back()+1 == cur) dq[2].pbk(cur);
                else dq[1].pbk(cur);
            }
            else {
                if(dq[1].back() + 1 == cur) dq[1].pbk(cur);
                else if(dq[2].back() + 1 == cur) dq[2].pbk(cur);
            }
        };
