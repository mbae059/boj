...
void Solve() {
    ...
    if(N*H>=2*S) print(min(getStrength1(v1),getStrength1(v2)));
    else print(min(getStrength2(v1),getStrength2(v2)));
}
int32_t main() {
