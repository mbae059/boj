...
//
bool LineInterSection(Line l1, Line l2) { //If l1, l2 is on the same line, then this isn't the one to use
    int l1_l2 = CCW(l1.p1, l1.p2, l2.p1) * CCW(l1.p1, l1.p2, l2.p2);
    int l2_l1 = CCW(l2.p1, l2.p2, l1.p1) * CCW(l2.p1, l2.p2, l1.p2);
    bool ret = (l1_l2 < 0) && (l2_l1 < 0);
    return ret;
}
...
void Solve() {
    ...
    if((p1==p3 && p2==p4) || (p1==p4 && p2==p3)) cout << 0;
    else cout << LineInterSection(l1, l2);
