...
void dfs(int x, int y) {
    ...
    rep(i,0,sz-1) {
        ...
        //case 1 vertical u, v
        auto [u,v] = domino[i];
        if(x<=8 && sudoku[x+1][y]==0 && r[x][u]==0 && r[x+1][v]==0 && c[y][u]==0 && c[y][v]==0) {
            r[x][u] = 1;
            r[x+1][v] = 1;
            c[y][u] = 1;
            c[y][v] = 1;
        ...
        //case 2 vertical v, u
        if(x<=8 && sudoku[x+1][y]==0 && r[x][v]==0 && r[x+1][u]==0 && c[y][u]==0 && c[y][v]==0) {
            r[x][v] = 1;
            r[x+1][u] = 1;
            c[y][u] = 1;
            c[y][v] = 1;
        ...
        //case 3 horizontal u, v
        if(y<=8 && sudoku[x][y+1]==0 && r[x][v]==0 && r[x][u]==0 && c[y][u]==0 && c[y+1][v]==0) {
            r[x][v] = 1;
            r[x][u] = 1;
            c[y][u] = 1;
            c[y+1][v] = 1;
        ...
        //case 4 horizontal v, u
        if(y<=8 && sudoku[x][y+1]==0 && r[x][v]==0 && r[x][u]==0 && c[y][v]==0 && c[y+1][u]==0) {
            r[x][v] = 1;
            r[x][u] = 1;
            c[y][v] = 1;
            c[y+1][u] = 1;
...
void Solve() {
    ...
    for(int z=1;;z++) {
        ...
        rep(i,1,N) {
            ...
            c[y][v] = 1;
            if(u>v) swap(u,v);
            domino.erase(find(all(domino), make_pair(u,v)));
        }
