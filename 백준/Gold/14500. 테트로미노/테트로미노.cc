...
set<vpii> tetromino;
void setTetromino() {
    tetromino.insert({{0,0},{1,0},{2,0},{3,0}});
    tetromino.insert({{0,0},{0,1},{0,2},{0,3}});

    tetromino.insert({{0,0},{1,0},{0,1},{1,1}});

    tetromino.insert({{0,0},{1,0},{2,0},{2,1}});
    tetromino.insert({{0,0},{1,0},{2,0},{2,-1}});
    tetromino.insert({{0,0},{0,-1},{1,-1},{2,-1}});
    tetromino.insert({{0,0},{0,1},{1,1},{2,1}});
    
    tetromino.insert({{0,0},{0,1},{0,2},{-1,2}});
    tetromino.insert({{0,0},{0,1},{0,2},{1,2}});
    tetromino.insert({{0,0},{-1,0},{-1,1},{-1,2}});
    tetromino.insert({{0,0},{1,0},{1,1},{1,2}});

    tetromino.insert({{0,0},{1,0},{1,1},{2,1}});
    tetromino.insert({{0,0},{1,0},{1,-1},{2,-1}});
    tetromino.insert({{0,0},{0,1},{-1,1},{-1,2}});
    tetromino.insert({{0,0},{0,1},{1,1},{1,2}});

    tetromino.insert({{0,0},{0,1},{-1,1},{1,1}});
    tetromino.insert({{0,0},{1,0},{2,0},{1,1}});
    tetromino.insert({{0,0},{0,1},{1,1},{0,2}});
    tetromino.insert({{0,0},{0,1},{-1,1},{0,2}});
}
void chk(int y, int x) {
    for(auto v : tetromino) {
        [&]() {
            int sum = 0;
            rep(i,0,3) {
                int nexty = y+v[i].first;
                int nextx = x+v[i].second;
                if(!inRange(nexty, nextx)) return;
