...
void Solve() {
    ...
    for(int i=3;i<=N;i+=2) {
        if(a[i-1]=='&') prefix[i] = (prefix[i-2] & a[i]);
        if(a[i-1]=='|') prefix[i] = (prefix[i-2] | a[i]);
    }
    ...
    if(c=='T') {
        if(prefix[N]==1) print(0);
        else if(a[N-1]=='|') print(1);
        else if(prefix[N-2]) print(1);
        else if(a[N]==0) print(2);
        else print(1);
    }
    else {
        if(prefix[N]==0) print(0);
        else if(a[N-1]=='&') print(1);
        else if(prefix[N-2]==0) print(1);
        else if(a[N]==0) print(1);
        else print(2);
    }
}
int32_t main() {
