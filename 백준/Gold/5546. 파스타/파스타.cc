...
void Solve() {
    ...
    for(int i=2;i<=N;i++) {
        if(a[i]) {
            dp[i][1][a[i]] = dp[i-1][0][1] + dp[i-1][1][1] + dp[i-1][2][1] + dp[i-1][3][1];
            dp[i][2][a[i]] = dp[i-1][0][2] + dp[i-1][1][2] + dp[i-1][2][2] + dp[i-1][3][2];
            dp[i][3][a[i]] = dp[i-1][0][3] + dp[i-1][1][3] + dp[i-1][2][3] + dp[i-1][3][3];

            dp[i][a[i]][a[i]] -= dp[i-1][a[i]][a[i]];
        }
        else {
            dp[i][1][1] = dp[i-1][0][1] + dp[i-1][2][1] + dp[i-1][3][1];
            dp[i][2][1] = dp[i-1][0][2] + dp[i-1][1][2] + dp[i-1][2][2] + dp[i-1][3][2];
            dp[i][3][1] = dp[i-1][0][3] + dp[i-1][1][3] + dp[i-1][2][3] + dp[i-1][3][3];
            
            dp[i][1][2] = dp[i-1][0][1] + dp[i-1][1][1] + dp[i-1][2][1] + dp[i-1][3][1];
            dp[i][2][2] = dp[i-1][0][2] + dp[i-1][1][2] + dp[i-1][3][2];
            dp[i][3][2] = dp[i-1][0][3] + dp[i-1][1][3] + dp[i-1][2][3] + dp[i-1][3][3];

            dp[i][1][3] = dp[i-1][0][1] + dp[i-1][1][1] + dp[i-1][2][1] + dp[i-1][3][1];
            dp[i][2][3] = dp[i-1][0][2] + dp[i-1][1][2] + dp[i-1][2][2] + dp[i-1][3][2];
            dp[i][3][3] = dp[i-1][0][3] + dp[i-1][1][3] + dp[i-1][2][3];
        }
        for(int j=1;j<=3;j++) {
            for(int k=1;k<=3;k++) {
                dp[i][j][k] %= mod;
