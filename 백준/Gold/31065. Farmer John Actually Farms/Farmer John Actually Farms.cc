...
void Solve() {
    ...
    // rep(i,1,N) cout << h[i].first << " ";
    // cout << endl;
    
    // rep(i,1,N) cout << a[i].first << " ";
    // cout << endl << endl;
    rep(i,1,N-1) {
        auto hi = h[i].first;
        auto hj = h[i+1].first;
        ...
        if(hi<=hj && ai<=aj);
            ...
            int denominator = ai-aj;
            int numerator = hj-hi;
            int val = numerator/denominator + (numerator%denominator!=0);
            chmin(r, val-1);
        }
        else if(hi>hj && ai<aj) {
            int denominator = ai-aj;
            int numerator = hj-hi;
            int val = numerator/denominator + 1;
            chmax(l, val);
        }
        else {
            cout << -1 << endl;
