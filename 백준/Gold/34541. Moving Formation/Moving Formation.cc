...
void Solve() {
    ...
    while(p!=make_pair(X,Y)) {
        if(p.first!=X) {
            p.first++;
            v.pbk({0, p.first, p.second});
        }
        else if(p.second!=Y) {
            p.second++;
            v.pbk({1, p.first, p.second});
        }
    }
    cout << v.size() * 4 + 6 << endl;
    ...
    cout << "B " << p.first << " " << p.second+N << endl;
    cout << "D " << p.first+N << " " << p.second << endl;
    cout << "C " << p.first+N << " " << p.second+N << endl;
}
int32_t main() {
