...
void Solve() {
    ...
    rep(k,1,N) {
        ...
        parent[k] = k;
        rep(i,y1,y2) {
            if(matrix[x1][i]!=0) unionParent(matrix[x1][i], k);
            if(matrix[x2][i]!=0) unionParent(matrix[x2][i], k);
        ...
        rep(i,x1,x2) {
            if(matrix[i][y1]!=0) unionParent(matrix[i][y1], k);
            if(matrix[i][y2]!=0) unionParent(matrix[i][y2], k);
    ...
    cout << (matrix[500][500] == 0 ? s.size() : s.size()-1);
