...
*/
//returns the amount of change. it is guaranteed that a1>=a2 && b1<b2
int mod(int x, int div) {
    if(x%div==0) return x/div;
    else return x/div+1;
}
int toLower1(int& A1, int& A2, int& B1, int& B2) {
    int dif = A1-A2;
    int need = B2-B1;
    if(need<=0 || dif <=0) return 0;
    if(9*dif>=need) {
        int x;
        if(need%9==0) x = need/9;
        else x = need/9+1;
...
int toLower2(int& A1, int& A2, int& B1, int& B2) {
    int dif = A1-A2;
    int need = B2-B1;
    if(need<=0 || dif <=0) return 0;
    if(81*dif>=need) {
        int x;
        if(need%81==0) x = need/81;
        else x = need/81+1;
...
//A1<A2 && B1>=B2
int toUpper1(int& A1, int& A2, int& B1, int& B2) {
    int need = A2-A1;
    int dif = (B1-B2)/11;
    if(need<=0 || dif <=0) return 0;
    if(dif>=need) {
...
//A1<A2 && B1>=B2
int toUpper2(int& A1, int& A2, int& B1, int& B2) {
    int need = A2-A1;
    int dif = (B1-B2)/121;
    if(need<=0 || dif <=0) return 0;
    if(dif>=need) {
