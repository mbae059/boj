...
void Solve() {
    ...
    if(p1.first==p2.first) {
        if((p1.first==p3.first) && ((p1.second < p3.second && p3.second < p2.second) || (p2.second < p3.second && p3.second < p1.second))) print(2);
        else print(0);
    }
    else if(p1.second==p2.second) {
        if((p1.second==p3.second) && ((p1.first < p3.first && p3.first < p2.first) || (p2.first < p3.first && p3.first < p1.first))) print(2);
        else print(0);
    }
    else print(1);
}
